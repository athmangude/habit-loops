    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50">
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full mx-4 text-center">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">HabitLoops</h1>
          <p className="text-gray-500">Track your habits with beautiful polar charts. Your data stays in your Google Drive.</p>
        </div>
